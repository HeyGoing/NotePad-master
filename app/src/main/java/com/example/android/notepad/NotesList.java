...
/*
        ...
        bac = getSharedPreferences("noteapp", MODE_PRIVATE);
        NoteAttribute.snoteBackground=bac.getInt(NoteAttribute.NOTEBACKGROUND,0);
        ...
        // The names of the cursor columns to display in the view, initialized to the title column
         dataColumns = new String[]{NotePad.Notes.COLUMN_NAME_TITLE, NotePad.Notes.COLUMN_NAME_CREATE_DATE};

        // The view IDs that will display the cursor columns, initialized to the TextView in
        // noteslist_item.xml
         viewIDs = new int[]{R.id.txt1, R.id.txt2};
